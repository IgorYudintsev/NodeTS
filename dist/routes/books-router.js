...
const booksDB_repositories_js_1 = require("../repositories/booksDB-repositories.js");
...
exports.booksRouter.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const foundBooks = yield booksDB_repositories_js_1.booksDBRepository.getBooks();
    res.send(foundBooks);
}));
exports.booksRouter.post("/", (0, express_validator_1.body)('volume').isLength({ min: 3, max: 30 }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newBookPromise = yield booksDB_repositories_js_1.booksDBRepository.postBooks(volume);
    res.status(201).json(newBookPromise);
}));
exports.booksRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let currentBook = yield booksDB_repositories_js_1.booksDBRepository.deleteBooks(req.params.id);
    if (currentBook) {
